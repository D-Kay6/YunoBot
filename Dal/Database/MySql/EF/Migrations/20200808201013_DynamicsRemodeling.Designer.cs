...
namespace Dal.Database.MySql.EF.Migrations
{
    ...
    [Migration("20200808201013_DynamicsRemodeling")]
    partial class DynamicsRemodeling
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entity.Role", b =>
                {
                    b.HasOne("Core.Entity.DynamicRole", null)
                        .WithMany("Roles")
                        .HasForeignKey("Roles");

                    b.HasOne("Core.Entity.ReactionRole", null)
                        .WithMany("Roles")
                        .HasForeignKey("Roles");
                });
