namespace Logic.Modules
{
    ...
    public class AutoChannelModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task AutoChannelDelete()
        {
            ...
            {
                if (await _channel.IsGeneratedChannel(Context.Guild.Id, channel.Id))
        ...
        public class AutoChannelPrefixModule : ModuleBase<SocketCommandContext>
        {
            ...
            {
                await ReplyAsync(_localization.GetMessage("Autochannel prefix default",
                    await _channel.GetAutoPrefix(Context.Guild.Id)));
            }
        ...
        public class AutoChannelNameModule : ModuleBase<SocketCommandContext>
        {
            ...
            {
                await ReplyAsync(_localization.GetMessage("Autochannel name default",
                    await _channel.GetAutoName(Context.Guild.Id)));
            }
