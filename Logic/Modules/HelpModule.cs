...
{prefix}music stop - Stop playing music and remove all songs from the queue.");
            ...
            embed.AddField("request", $@"{prefix}request feature - Send a message to my developer with the request for a new feature.
{prefix}request change - Send a message to my developer with the request for a change of an already existing feature.");
...
{prefix}prefix set (new prefix) - Change the command prefix for this server.");
            ...
            embed.AddField("autochannel (ac)", $@"{prefix}autochannel - Show the currently used icon for auto channels.
...
{prefix}autochannel fix - Fixes the problem where I am unable to remove generates auto channels.");
            ...
            embed.AddField("permachannel (pc)", $@"{prefix}permachannel - Show the currently used icon for perma channels
{prefix}permachannel seticon (new icon) - Change the icon for perma channels.");

            embed.AddField("autorole (ar)", $@"{prefix}autorole - Show the currently used icon for auto roles.
{prefix}autorole seticon (new icon) - Change the icon for auto roles.");

            embed.AddField("permarole (pr)", $@"{prefix}permarole - Show the currently used icon for perma roles
...
{prefix}request feature - Send a message to my developer with the request for a new feature.
{prefix}request change - Send a message to my developer with the request for a change of an already existing feature.");
            await ReplyAsync("", false, embed);
        }
